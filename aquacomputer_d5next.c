...
AUTO_POINT(1, 15);
AUTO_POINT(1, 16);
static SENSOR_DEVICE_ATTR_2(pwm1_auto_start_temp, 0644, d5next_get_auto_temp, d5next_set_auto_temp, 0, NUM_CTRL_CURVE_POINTS + 1);
...
AUTO_POINT(2, 15);
AUTO_POINT(2, 16);
static SENSOR_DEVICE_ATTR_2(pwm2_auto_start_temp, 0644, d5next_get_auto_temp, d5next_set_auto_temp, 1, NUM_CTRL_CURVE_POINTS + 1);
