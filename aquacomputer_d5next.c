...
enum kinds { aquaero6lt, d5next, farbwerk, farbwerk360, octo, quadro, highflownext };
...
/* Labels for Aquaero 6 LT, Farbwerk, Farbwerk 360, Octo and Quadro temperature sensors */
